...
interface ApplicationConstants
{
    ...
    const YVES_STORAGE_SESSION_REDIS_USERNAME = 'YVES_STORAGE_SESSION_REDIS_USERNAME';
    ...
    const ZED_STORAGE_SESSION_REDIS_USERNAME = 'ZED_STORAGE_SESSION_REDIS_USERNAME';
